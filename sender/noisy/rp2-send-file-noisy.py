...
def client_program():
    ...
    #filename = "board0009cycle0020_rgbnoise_rgb.png" 
    #filename = "board0009cycle0066_rgbnoise_rgb.png"


    filename = "board0040cycle0021_rgbnoise_rgb.png"

    filesize = os.path.getsize(filename) # get the file size
    
    ## for board 0009
    client_socket.send("Authentication request from board0040".encode("utf-8"))
